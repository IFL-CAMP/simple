...
std::unique_ptr<SIMPLE::TRANSFORM> simple::Publisher<SIMPLE::TRANSFORM>::createMSG(SIMPLE::HEADER* header, double px,
...
std::unique_ptr<SIMPLE::POSITION> simple::Publisher<SIMPLE::POSITION>::createMSG(SIMPLE::HEADER* header, double px,
...
std::unique_ptr<SIMPLE::STATUS> simple::Publisher<SIMPLE::STATUS>::createMSG(SIMPLE::HEADER* header, int code,
