...
template <>
std::unique_ptr<simple::TRANSFORM>
simple::Publisher<simple::TRANSFORM>::createMSG(
...
template <>
std::unique_ptr<simple::POSITION>
simple::Publisher<simple::POSITION>::createMSG(simple::HEADER* header,
...
template <>
std::unique_ptr<simple::STATUS> simple::Publisher<simple::STATUS>::createMSG(
...
simple::Publisher<simple::CAPABILITY>::createMSG(
...
template <>
std::unique_ptr<simple::GENERIC> simple::Publisher<simple::GENERIC>::createMSG(
