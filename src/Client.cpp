...
template <>
void simple::Client<simple::TRANSFORM>::readMsg(
...
template <>
void simple::Client<simple::POSITION>::readMsg(
...
template <>
void simple::Client<simple::STATUS>::readMsg(const simple::STATUS& msg,
...
template <>
void simple::Client<simple::CAPABILITY>::readMsg(
...
template <>
void simple::Client<simple::GENERIC>::readMsg(const simple::GENERIC& msg,
