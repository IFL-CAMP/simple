...
std::unique_ptr<SIMPLE::BASEMSG> simple::MSGcreator::createTRANSFORM(SIMPLE::HEADER* header, double px, double py, double pz, double r11, double r12, double r13, double r21, double r22, double r23, double r31, double r32, double r33){
...
std::unique_ptr<SIMPLE::BASEMSG> simple::MSGcreator::createPOSITION(SIMPLE::HEADER* header, double px, double py, double pz, double qi, double qj, double qk, double qr){
...
std::unique_ptr<SIMPLE::BASEMSG> simple::MSGcreator::createSTATUS(SIMPLE::HEADER* header, int code, int subcode, std::string errorName, std::string errorMsg){
...
std::unique_ptr<SIMPLE::BASEMSG> simple::MSGcreator::createCAPABILITY(SIMPLE::HEADER* header, std::vector<std::string> msgNames){
...
SIMPLE::HEADER* simple::MSGcreator::createHEADER(int versionNum, std::string dataTypeName, std::string deviceName, double timeStamp){
