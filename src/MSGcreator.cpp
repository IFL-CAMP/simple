...
std::unique_ptr<flatbuffers::FlatBufferBuilder> simple::createHeader(std::string datatypename, std::string devicename, int versionnum){
	...
	std::unique_ptr<flatbuffers::FlatBufferBuilder> fbb = std::make_unique<flatbuffers::FlatBufferBuilder>();//create flatbuffer builder (general)
...
std::unique_ptr<flatbuffers::FlatBufferBuilder> simple::createVec3(double x, double y, double z){
	std::unique_ptr<flatbuffers::FlatBufferBuilder> fbb = std::make_unique<flatbuffers::FlatBufferBuilder>();//create flatbuffer builder (general)
...
std::unique_ptr<flatbuffers::FlatBufferBuilder> simple::createQuaternion(double e1, double e2, double e3, double e4){
	std::unique_ptr<flatbuffers::FlatBufferBuilder> fbb = std::make_unique<flatbuffers::FlatBufferBuilder>();//create flatbuffer builder (general)
...
std::unique_ptr<flatbuffers::FlatBufferBuilder> simple::createTRANSFORM(flatbuffers::FlatBufferBuilder header, flatbuffers::FlatBufferBuilder position,
	flatbuffers::FlatBufferBuilder orientation){

	std::unique_ptr<flatbuffers::FlatBufferBuilder> fbb = std::make_unique<flatbuffers::FlatBufferBuilder>();//general flatbuffer builder
...
/*std::unique_ptr<flatbuffers::FlatBufferBuilder> createPOSITION(flatbuffers::FlatBufferBuilder header, double px, double py, double pz,
	double e1, double e2, double e3, double e4){

}
std::unique_ptr<flatbuffers::FlatBufferBuilder> createSTATUS(flatbuffers::FlatBufferBuilder header, int code, int subcode,
	const std::string& errorName, const std::string& errorMsg){

}
std::unique_ptr<flatbuffers::FlatBufferBuilder> createCAPABILITY(flatbuffers::FlatBufferBuilder header, const
...
std::unique_ptr<flatbuffers::FlatBufferBuilder> createGENERIC_DOUBLE(flatbuffers::FlatBufferBuilder header, double data){

}
std::unique_ptr<flatbuffers::FlatBufferBuilder> createGENERIC_STR(flatbuffers::FlatBufferBuilder header, const std::string& data){
