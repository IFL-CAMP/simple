...
std::shared_ptr<flatbuffers::FlatBufferBuilder> createTRANSFORM(const flatbuffers::FlatBufferBuilder& header,
                                                                const flatbuffers::FlatBufferBuilder& vector,
                                                                const flatbuffers::FlatBufferBuilder& quaternion);
///@brief
///@param x
///@param y
///@param z
///@return
std::shared_ptr<flatbuffers::FlatBufferBuilder> createVec3(double x, double y, double z);
///@brief
///@param x
///@param y
///@param z
///@return
std::shared_ptr<flatbuffers::FlatBufferBuilder> createQuaternion(double e1, double e2, double e3, double e4);
...
std::shared_ptr<flatbuffers::FlatBufferBuilder> createPOSITION(flatbuffers::FlatBufferBuilder header, double px,
...
std::shared_ptr<flatbuffers::FlatBufferBuilder> createSTATUS(flatbuffers::FlatBufferBuilder header, int code,
...
std::shared_ptr<flatbuffers::FlatBufferBuilder> createCAPABILITY(flatbuffers::FlatBufferBuilder header,
...
///@return pointer to message of type GENERIC
std::shared_ptr<flatbuffers::FlatBufferBuilder> createGENERIC_DOUBLE(flatbuffers::FlatBufferBuilder header,
                                                                     double data);
...
///@return pointer to message of type GENERIC
std::shared_ptr<flatbuffers::FlatBufferBuilder> createGENERIC_STR(flatbuffers::FlatBufferBuilder header,
                                                                  const std::string& data);

std::shared_ptr<flatbuffers::FlatBufferBuilder> createHeader(std::string datatypename, std::string devicename,
                                                             int versionnum);
