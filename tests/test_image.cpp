...
SCENARIO("Using an Image Message")
{
  ...
  GIVEN("An image") {
	  ...
	  WHEN("I copy construct a new image from the existing image's buffer") {
		  ...
		  THEN("The two images are the same") {
			  REQUIRE(buffer_copy_image == random_image);
		  }
	  }
  ...
  GIVEN("An image") {
	  ...
	  WHEN("I copy assign a new image from the existing image's buffer") {
		  ...
		  THEN("The two images are the same") {
			  REQUIRE(buffer_assigned_image == random_image);
		  }
	  }
	  WHEN("I copy-assign a new image") {
		  ...
		  THEN("Both images are the same") {
			  REQUIRE(copy_assigned_image == random_image);
		  }
	  }
  ...
  GIVEN("Two identical images") {
	  ...
	  WHEN("I compare them") {
		  THEN("They have to be the same") {
			  REQUIRE(random_image1 == random_image2);
		  }
	  }
  ...
  GIVEN("A uint8_t Image created from an empty constructor")
  {
	  ...
	  WHEN("I set the image encoding") {
		  ...
		  THEN("The encoding is correct") {
			  REQUIRE(empty_image.getImageEncoding() == random_string);
		  }
	  }
	  ...
	  WHEN("I set the image header") {
		  ...
		  THEN("The header is correct") {
			  REQUIRE(empty_image.getHeader() == random_header);
		  }
	  }
	  WHEN("I set the image origin") {
		  empty_image.setOrigin(random_pose);
		  THEN("The origin is correct") {
			  REQUIRE(empty_image.getImageOrigin() == random_pose);
		  }
	  }
