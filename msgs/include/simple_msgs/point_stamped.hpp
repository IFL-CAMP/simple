...
public:
   ...
   */
  PointStamped(PointStamped&& other) noexcept;

  /**
   * @brief Copy assignment operator.
   */
  PointStamped& operator=(const PointStamped& rhs);

  /**
   * @brief Move assignment operator.
   */
  PointStamped& operator=(PointStamped&& rhs) noexcept;
   ...
   */
  friend std::ostream& operator<<(std::ostream& out, const PointStamped& p);
...
protected:
   ...
   */
  PointStamped& operator=(std::shared_ptr<void*> rhs) override;
